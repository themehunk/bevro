...
= 1.1.1 =
* Update: Header implementation through hooks using do_action( 'bevro_header' );
* Update: Footer implementation through hooks using do_action( 'bevro_footer' );
...
Resource link: https://burst.shopify.com/licenses/creative-commons
Licensed under the CCO license.
License link : https://burst.shopify.com/licenses/creative-commons

2. Image name: bevro-shop.png
Resource link: https://burst.shopify.com/photos/man-in-french-cuff-fashion?c=fashion
Licensed under the CCO license.
License link : https://burst.shopify.com/licenses/creative-commons
...
== class-control-color.php ==
License : MIT License
License URL : http://opensource.org/licenses/mit-license.html
...
== breadcrumb.php ==
breadcrumbs.php, Copyright Justin Tadlock 
License: GNU GPL License, version 0.2.1 Source: https://github.com/justintadlock/breadcrumb-trail/

==  Other Licenses ==
Other js and php files are self coded.