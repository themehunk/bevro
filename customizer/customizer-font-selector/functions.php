 ...
 * @since 1.1.38
 */
function bevro_get_standard_fonts(){
 ...
 * @since 1.1.38
 */
function bevro_get_google_fonts_array(){
 ...
 * @since 1.1.38
 */
function bevro_enqueue_google_font($font){
	...
	$subsets        = '';
	$get_subsets    = get_theme_mod( 'bevro_font_subsets', array( 'latin' ) );
	...
	// Enqueue style
	wp_enqueue_style( 'bevro-google-font-' . $handle, $url, array(), false );
}