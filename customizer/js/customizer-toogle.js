...
( function( $ ){
	...
	ZTAControlTrigger = {
	    ...
	    {
	    	$( 'body' ).trigger( 'bevro-control-trigger.' + hook, args );
	    },
	    ...
	    {
	    	$( 'body' ).on( 'bevro-control-trigger.' + hook, callback );
	    },
	    ...
	    {
		    $( 'body' ).off( 'bevro-control-trigger.' + hook, callback );
	    },
	};
...
( function( $ ){
	...
	ZTACustomizer = {
		...
		_initToggles: function()
		{
			...
			ZTAControlTrigger.triggerHook( 'bevro-toggle-control', api );
