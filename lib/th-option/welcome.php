...
<div class="theme_link">
    ...
    <p><?php _e('We highly Recommend to install ThemeHunk Customizer plugin to get all customization options in Bevro theme. Also install recommended plugins available in recommended tab.','big-store'); ?></p>
</div>
<div class="theme_link">
    <h3><?php _e('2. Setup Home Page','big-store'); ?><!-- <php echo $theme_config['plugin_title']; ?> --></h3>
        <p><?php _e('To set up the HomePage in Bevro theme, Just follow the below given Instructions.','big-store'); ?> </p>
...
<div class="theme_link">
    ...
    <p><?php _e('Bevro theme support live customizer for home page set up. Everything visible at home page can be changed through customize panel','big-store'); ?></p>
    <p>
