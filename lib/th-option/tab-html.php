...
<div class="th-option-area">
        <div class="th-option-top-hdr">
            ...
            <div class="col-2">
                ...
                <span><?php echo _e('FREE THEME','bevro'); ?></span>
            </div>
        </div>
        <div class="th-option-bottom-hdr">
            <a class="tablinks active" onclick="openTab(event, 'Welcome')"><?php _e('Welcome','bevro');?></a>
            <a class="tablinks" onclick="openTab(event, 'Recommended-Plugin')"><?php _e('Recommended Plugin','bevro');?> </a>

            <a class="tablinks" onclick="openTab(event, 'Import-Demo-Content')"><?php _e('Demo Import','bevro');?> </a>
            
            <a class="tablinks get-child" onclick="openTab(event, 'Get-Child-Theme')"><?php _e('Get Child Theme','bevro');?></a>
            <a class="tablinks" onclick="openTab(event, 'Free-Vs-Pro')"><?php _e('Free Vs Pro','bevro');?></a>
            <a class="tablinks" onclick="openTab(event, 'Help')"><?php _e('Help','bevro');?></a>
          ...
          <div id="Import-Demo-Content" class="tabcontent">
            ...
            <div class="rp-two-column">
                ...
                <h3><?php _e('Click Here To Import Demo Content','bevro'); ?></h3>
				 ...
				 <p> <?php _e('You need to Install required plugins like- WooCommerce and One click demo import plugin. After installing required plugins import button will activate.', 'bevro'); ?></p>
