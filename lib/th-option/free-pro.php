            ...
            <table class="table">
               <tbody class="table-body">
                  <tr class="table-head">
                     ...
                     <th class="status" align="center"><?php _e('Bevro','big-store'); ?> </th>
                     <th class="status" align="center"><?php _e('Bevro Pro','big-store'); ?> </th>
                  </tr>
                  ...
                  <tr class="feature-row">
                   ...
                   <tr class="feature-row">
                    ...
                    <tr class="feature-row th-buy-pro">
                     ...
                     <td class="status success"><a href="https://themehunk.com/product/big-store-pro/" target="_blank" rel="external noreferrer noopener" class="components-button is-primary"><?php _e('Get Bevro Pro Now','big-store'); ?></a></td>
                  </tr>
