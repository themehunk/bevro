 ...
 * Theme Options
 */
if ( ! class_exists( 'Bevro_Theme_Options' ) ){
	/**
	 * Theme Options
	 */
	  class Bevro_Theme_Options {
		/**
		 * Class instance.
		 *
		 * @access private
		...
		public static function defaults(){
			...
			return apply_filters(
				'bevro_theme_defaults', array(	
	
			    'bevro-blog-single-structure-meta'    => array(
						'image',
						'title'
					),
			    'bevro-blog-meta-single'    => array(
						'comments',
						'category',
						'author',
						'date',
					),
			    'bevro-blog-structure-meta'    => array(
						'image',
						'title'
					),
			    'bevro-blog-meta'    => array(
						'comments',
						'category',
						'author',
						'date',
		...
		public static function refresh() {
			self::$db_options = wp_parse_args(
				get_option( BEVRO_THEME_SETTINGS ),
				self::defaults()
			);
		}
	}
 ...
 */
Bevro_Theme_Options::get_instance();
